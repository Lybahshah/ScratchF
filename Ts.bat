...
set SummaryReportPath=C:\Users\Admin\source\repos\ScratchF\TestSummaryreport
...
TestCaseFilter:"TestCategory=%testcategory%" /Logger:"trx;LogFileName=c:\TestSummaryReport\%filename%\%filename%.trx"
